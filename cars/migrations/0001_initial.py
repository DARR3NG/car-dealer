    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Tanger-Tétouan-Al Hoceïma', 'TAN'), ('Oriental', 'ORI'), ('Fès-Meknès', 'FES'), ('Rabat-Salé-Kénitra', 'RSA'), ('Béni Mellal-Khénifra', 'BEM'), ('Casablanca-Settat', 'CAS'), ('Marrakech-Safi', 'MAR'), ('Drâa-Tafilalet', 'DRA'), ('Souss-Massa', 'SOU'), ('Guelmim-Oued Noun', 'GUE'), ('Laâyoune-Sakia El Hamra', 'LAA'), ('Dakhla-Oued Ed-Dahab', 'DAK')], max_length=100)),
